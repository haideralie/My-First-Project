             ...
             <div class="row">
                ...
                <form action="{{url('/storeContactUs')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="block_name"><strong>Block Name</strong></label>
                    <input type="text" class="form-control" name="block_name" id="block_name" required="true">
                    </div>
                    
                   <!-- <div class="form-group">
                      <label for="plotsize"><strong>Plot Size</strong></label>
                      <input type="plotsize" class="form-control" name="plotsize" required="true" >
                    </div> -->

                    <div class="form-group">
                      <label for="sale_purchase"><strong> Sale Or Purchase</strong></label>
                      <input type="text" class="form-control" name="sale_purchase" required="true">

                      <li>
                            <input class="form-check-input" type="radio" name="plotsize" id="exampleRadios1" value="3-Marla" >
                    ...
                    <div class="form-group">
                      ...
                      <label class="form-check-label" for="exampleRadios1">
                        &nbsp;3-Marla
                          ...
                          <li>
                               <input class="form-check-input" type="radio" name="plotsize" id="4-Marla" value="4-Marla" >
                          ...
                          <li>
                               <input class="form-check-input" type="radio" name="plotsize" id="5-Marla" value="5-Marla" >
                          <label class="form-check-label" for="exampleRadios1">
                            &nbsp;5-Marla
                          </label>
                          </li>
                          ...
                          <li>
                               <input class="form-check-input" type="radio" name="plotsize" id="exampleRadios1" value="6-Marla" >
                          <label class="form-check-label" for="exampleRadios1">
                           &nbsp;6-Marla
                          </label>
                          </li>
                          ...
                          <li>
                               <input class="form-check-input" type="radio" name="plotsize" id="8-Marla" value="8-Marla" >
                          ...
                          <li>
                               <input class="form-check-input" type="radio" name="plotsize" id="10-Marla" value="10-Marla" >
                          <label class="form-check-label" for="exampleRadios1">
                            10-Marla
                          </label>
                          </li>
                   ...
                   <div class="form-group">
                        <label for="city1"><strong>City</strong></label>
                        <select name="city1" class="form-control" required="true">
                       ...
                       <!--<div class="form-group">
                        ...
                        <textarea class="form-control" id="comments"  name="comments" rows="3" required="true"></textarea>
                      </div> -->
